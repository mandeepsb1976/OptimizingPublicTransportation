...
#         = f"chicago.opt.station.arrivals" # TODO: Come up with a better topic name
        super().__init__(
#             topic_name,
            "chicago.opt.station.arrivals",
...
#         logger.info("arrival kafka integration incomplete - skipping")
        ...
        self.producer.produce(
           ...
           value={"station_id": self.station_id,"train_id": train.train_id,
                  "direction": direction, "line": self.color.name,
